...
class ObjectiveCFileOptions : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_class_suffix() const;
  inline void clear_class_suffix();
  static const int kClassSuffixFieldNumber = 3;
  inline const ::std::string& class_suffix() const;
  inline void set_class_suffix(const ::std::string& value);
  inline void set_class_suffix(const char* value);
  inline void set_class_suffix(const char* value, size_t size);
  inline ::std::string* mutable_class_suffix();
  inline ::std::string* release_class_suffix();
  inline void set_allocated_class_suffix(::std::string* class_suffix);
 ...
 private:
  ...
  inline void set_has_class_suffix();
  inline void clear_has_class_suffix();
...
// optional string class_suffix = 3;
inline bool ObjectiveCFileOptions::has_class_suffix() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void ObjectiveCFileOptions::set_has_class_suffix() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ObjectiveCFileOptions::clear_has_class_suffix() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void ObjectiveCFileOptions::clear_class_suffix() {
  if (class_suffix_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    class_suffix_->clear();
  }
  clear_has_class_suffix();
}
inline const ::std::string& ObjectiveCFileOptions::class_suffix() const {
  // @@protoc_insertion_point(field_get:google.protobuf.ObjectiveCFileOptions.class_suffix)
  return *class_suffix_;
}
inline void ObjectiveCFileOptions::set_class_suffix(const ::std::string& value) {
  set_has_class_suffix();
  if (class_suffix_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    class_suffix_ = new ::std::string;
  }
  class_suffix_->assign(value);
  // @@protoc_insertion_point(field_set:google.protobuf.ObjectiveCFileOptions.class_suffix)
}
inline void ObjectiveCFileOptions::set_class_suffix(const char* value) {
  set_has_class_suffix();
  if (class_suffix_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    class_suffix_ = new ::std::string;
  }
  class_suffix_->assign(value);
  // @@protoc_insertion_point(field_set_char:google.protobuf.ObjectiveCFileOptions.class_suffix)
}
inline void ObjectiveCFileOptions::set_class_suffix(const char* value, size_t size) {
  set_has_class_suffix();
  if (class_suffix_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    class_suffix_ = new ::std::string;
  }
  class_suffix_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:google.protobuf.ObjectiveCFileOptions.class_suffix)
}
inline ::std::string* ObjectiveCFileOptions::mutable_class_suffix() {
  set_has_class_suffix();
  if (class_suffix_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    class_suffix_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:google.protobuf.ObjectiveCFileOptions.class_suffix)
  return class_suffix_;
}
inline ::std::string* ObjectiveCFileOptions::release_class_suffix() {
  clear_has_class_suffix();
  if (class_suffix_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
    ::std::string* temp = class_suffix_;
    class_suffix_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
inline void ObjectiveCFileOptions::set_allocated_class_suffix(::std::string* class_suffix) {
  if (class_suffix_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete class_suffix_;
  }
  if (class_suffix) {
    set_has_class_suffix();
    class_suffix_ = class_suffix;
  } else {
    clear_has_class_suffix();
    class_suffix_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  }
  // @@protoc_insertion_point(field_set_allocated:google.protobuf.ObjectiveCFileOptions.class_suffix)
}
